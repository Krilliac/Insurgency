...
if (_dragger call tcb_fnc_checklauncher) exitWith {[format ["You cant carry others if you have a launcher on your back."],0, 0.035 * safezoneH + safezoneY,5,0.3] spawn BIS_fnc_dynamicText};
