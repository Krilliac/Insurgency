...
// INDEPENDENT AAF FACTION	
	...
	_MotPool=	["I_MRAP_03_F","I_MRAP_03_hmg_F"];
	_ACHPool=	["I_Heli_light_03_F"];
	_CHPool=	["I_Heli_Transport_02_F","B_Heli_Light_02_unarmed_F","I_Heli_light_03_unarmed_F"];
	_uavPool=	["I_UAV_01_F","I_UAV_02_CAS_F","I_UGV_01_rcws_F"];
	_stPool=	["I_Mortar_01_F","I_HMG_01_A_F","I_GMG_01_A_F","I_static_AA_F","I_static_AT_F"];
